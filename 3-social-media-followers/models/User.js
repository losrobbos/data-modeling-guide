...
const UserSchema = new Schema({
  ...
  followers: [{ type: Schema.Types.ObjectId, ref: 'User' }], // the people who follow this user...
  ...
  // populating the followers works just as usual: User.findById(...).populate("followers")
    ...
    // so it will not populate again the followers of the followers or the followers... (preventing potentially endless populate cycles)
})
